...
$(document).ready(function() {
    $('.music-slider').owlCarousel({
      ...
      responsive: {
        0: {
          items: 1, // Number of items to show in the carousel on smaller screens
          nav: false
        },
        768: {
          items: 3, // Number of items to show in the carousel on medium screens
          nav: true
        },
        1024: {
          items: 4, // Number of items to show in the carousel on larger screens
          nav: true,
          loop: false
        }
      }
