...
<?php 
  include 'includes/conn2.php';
    $p=$_GET['p'];
                $pastorates=  mysqli_query($con,"SELECT * FROM pastorates  WHERE pastorate_id='$p' ");
                $row3=mysqli_fetch_array($pastorates);
             $pastorate=$row3['pastorate'];
          
  ?>
<head>
   <title>Leaders from <?php echo $pastorate; ?>-AICT</title>
    <!-- Meta -->
    <meta charset="utf-8">
        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">Leaders from <?php echo $pastorate;?></h1>
