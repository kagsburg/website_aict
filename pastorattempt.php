...
<!--    <div class='nav'>
    ...
    <div class="clear"></div>
          ...
          <div class='errors' style='color:yellow; width: 89%; text-align: center;float:left; margin-left: 5px;padding: 5px; margin-top:10px; font-size:12px;'>unable to login,please try again </div>
