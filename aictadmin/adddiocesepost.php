...
<head>
		...
		<title>Add Diocese Post- Aic Admin</title>
				...
				<div class="container">
					  <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Add Diocese  Post</h4>
                            </div>
                        </div>
...
echo '<div class="alert alert-danger">'.$error.'</div><br/>';
  ...
  mysqli_query($con,"INSERT INTO dioceseposts(diocese_id,title,description,ext,timestamp,status)  VALUES('$diocese','$title','$description','$image_ext',UNIX_TIMESTAMP(),'$status')") or die(mysqli_error($con));
...
create_thumb('../diocese/',$image_file,'../diocese/thumbs/');
    ...
    ?>             
                                    <form action=""  method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="text" name="title" parsley-trigger="change" required     placeholder="Enter post title" class="form-control" id="title">
                                        </div>
				...
				<label  for="name1">Diocese</label>
                      ...
                      while($row1=mysqli_fetch_array($dioceses)){
                   $diocese=$row1['diocese'];
