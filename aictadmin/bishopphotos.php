...
<head>
		...
		<title>Bishop photos- Aic Admin</title>
...
<?php include 'includes/header.php';?>
           ...
           ?>
                                <h4 class="page-title"><?php echo $fullname;?> Photos</h4>
           ...
           <div class="col col-lg-2">
               <img src="../leaders/bishops/<?php echo md5($id).'.'.$ext;?>"  class="img img-responsive img-thumbnail">
...
echo '<div class="error" style="float:right; margin-right:20%;font-weight:normal;font-size:1.2em; padding:3px;">'.$error.'</div><br/>';
                     ...
                     mysqli_query($con,"INSERT INTO bishopphotos(bishop_id,ext,published,caption) VALUES('$id','$image_ext','$published','$caption')") or die(mysql_error());
                    
                       $image_id=mysqli_insert_id($con);
                       $photo_name=md5(mysqli_insert_id($con));
                                     $image_file=$photo_name.'.'.$image_ext;
                                     move_uploaded_file($tmp_name,'../leaders/bishops/photos/'.$image_file);
                                                         mysqli_query($con,"DELETE FROM bishopphotos WHERE ext=''");
   ...
   function validatephotos()
{
		...
		$("#image1").focus();
            ...
            return true;
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                          <?php  
   $photos=  mysqli_query($con,"SELECT * FROM bishopphotos WHERE bishop_id='$id' AND published='published'");
  ...
  echo '<div class="alert alert-danger" style="text-align:center"> Oops!!You have No photos uploaded yet </div>';  }
      ...
      while ($row = mysqli_fetch_array($photos)){
       ...
       <img src="<?php echo '../leaders/bishops/photos/'.md5($photo_id).'.'.$photo_ext;?>" alt="<?php echo $caption; ?>" title="<?php echo $caption; ?>"  title="click to view photos" width="100">
   </a></td>
...
<form action="bishopcaption.php?id=<?php echo $photo_id;?>" method="post" name="form<?php echo $photo_id;?>">
			<fieldset>
		                            <div class="form-group">
...
<script>
 ...
 frmvalidator.EnableMsgsTogether();
      ...
      frmvalidator.addValidation("caption<?php echo $id?>","req","caption not entered");
       ...
       <a href="unpublishbishopphoto?id=<?php echo $photo_id;?>&&published=<?php echo $published;?>" class="btn btn-xs  btn-danger" onclick="return approve<?php echo $photo_id; ?>()">unpublish <i class="fa  fa-thumbs-down"></i></a>
