...
include 'includes/conn.php';
     if((!isset($_SESSION['aictwork']))||($_SESSION['aictwork']=='general secretary')){
...
<?php include 'includes/pastormenu.php';?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Employees</h4>
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30"> Employees</h4>
   ...
   <?php 
    $getchurch=  mysqli_query($con,"SELECT * FROM churches WHERE status='1'  AND church_id='".$_SESSION['aicchurch']."'");
             ...
             $users=  mysqli_query($con,"SELECT * FROM  registered_users   WHERE position='employee' AND status='active' ");
               if(mysqli_num_rows($users)<1){
                 echo '<div  class="alert alert-danger">No Employees Added yet</div>';
             }
           else{
             while ($row1=mysqli_fetch_array($users)){
                 $usename=$row1['username'];
                 $church_id1=$row1['church_id'];
                  $employees=  mysqli_query($con,"SELECT * FROM employees   WHERE username='$usename'");
