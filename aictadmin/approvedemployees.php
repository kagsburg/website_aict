...
<?php include 'includes/header.php';?>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">All Approved Employees</h4>
                                                              <div class="card-box">
                                  

                                    <h4 class="header-title m-t-0 m-b-30">All Approved Employees</h4>
   ...
   <?php 
             $employees=  mysqli_query($con,"SELECT * FROM employees   WHERE status='approved' ORDER BY employee_id DESC");
...
$dept=$row1['department'];
   ...
   <td><?php echo $dob;?></td>
                ...
                <td width="80">
                                            <a href="employeestatus.php?id=<?php echo $employee_id;?>&&st=<?php echo  $status; ?>&&user=<?php echo $username; ?>" class="ask" onclick="return confirm_delete<?php echo $employee_id; ?>()"><button class="btn btn-xs btn-danger">Remove<i class="icon-white icon-thumbs-down"></i></button></a>
     <script type="text/javascript">
function confirm_delete<?php echo $employee_id;?>() {
  return confirm('are you sure you want to remove Employee?');
}
</script>              
    </td>
             <?php   } ?>    
