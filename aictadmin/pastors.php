					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href="addpastor" class="btn btn-info btn-lg" style="margin:5px 0px"><i class="fa fa-plus"></i> Add Pastor</a>
                                <div class="card-box">
...
<td>                           
    <a href="activatepastor.php?pastor_id=<?php echo $pastor_id;?>&&status=<?php echo $status2;?>" onclick="return confirm_delete<?php echo $pastor_id; ?>()"><button class="btn btn-xs btn-danger">Remove <i class="fa  fa-thumbs-down"></i></button></a>       
    <a  href="editpastor?id=<?php echo $pastor_id;?>"  button class="btn btn-xs btn-warning">Edit</a>    
...
function confirm_delete<?php echo $pastor_id;?>() {
  return confirm('are you sure you want to remove Pastor?');
}
function confirm_demote<?php echo $pastor_id;?>() {
  return confirm('are you sure you want to demote Secretary?');
}
</script>                           
             <?php  } ?>                  
  </tr>
