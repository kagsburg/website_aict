                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12  avt" style="text-align: center">                            
                            <a  href="open"   class="btn btn-primary">Visit Public Forum</a>   
                ...
                <div class="container" style="margin-top: 20px">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                             <div class="alert alert-info">NB:Your comments  on any of the topics below shall not be displayed to the public</div>
                            <!-- POST -->
                     <?php
                     $gettopics=  mysqli_query($con,"SELECT * FROM topics WHERE status=1 AND type='no' ORDER BY topic_id DESC");
...
<div class="comments">
                                ...
                                <div class="postinfo pull-left">
                                    <a data-toggle="modal" class="btn btn-primary btn-xs" href="#modal-form<?php echo $topic_id; ?>" style="padding: 5px 10px;font-size: 12px;line-height: 1.5;background: #920c8b;margin-top:15px;margin-left: 5px;border-radius: 3px;">comment</a>
...
<h3 id="myModalLabel">Post Comment</h3>
                     ...
                     while ($row = mysqli_fetch_array($getcats)) {
                         ...
                         $forumcategory=$row['forumcategory'];
                                                                   $gettopics=  mysqli_query($con,"SELECT * FROM topics WHERE category_id='$forumcategory_id' AND type='no'");
                            ?>
                                        <li><a href="pcategory?c=<?php echo $forumcategory_id; ?>"><?php echo $forumcategory; ?><span class="badge pull-right badge-primary"><?php echo mysqli_num_rows($gettopics); ?></span></a></li>
                     <?php }?>
                                    </ul>
                                </div>
                            </div>
