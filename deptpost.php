...
$id=$_GET['id'];
             $article=  mysqli_query($con,"SELECT * FROM deptposts  WHERE  deptpost_id='$id'");
...
<meta property="og:image" content="<?php echo BASE_URL; ?>/deptposts/<?php echo md5($id).'.'.$ext;?>" />
			...
			<div class="container">
				<div class="col-md-12">
					<div class="sermon-content-single">
						<div class="row">
							<div class="col-md-16">
								<img src="<?php echo BASE_URL.'/deptposts/'.md5($id).'.'.$ext;?>" class="img-responsive" alt=""/>
				...
				<aside class="col-md-4">
					...
					<div class="side-widget">
						<h5>Other Department Posts</h5>
						<ul class="sermon-list">
                        <?php 
                          $articles=  mysqli_query($con,"SELECT * FROM deptposts  WHERE  dept_id='$dept_id' AND deptpost_id!='$id' LIMIT 4");
                            ...
                            while($row=mysqli_fetch_array($article)){
                             ...
                             $description=$row['description'];
                               ...
                               $timestamp=$row['timestamp'];
                                                             ...
                                                             ?>
                                                             <li>
                                                             <a href="<?php $tit= str_replace('/','-',$title); echo BASE_URL.'/post/'.$deptpost_id.'/'.str_replace(' ','-',$tit);?>.html">
                                        <img <?php echo BASE_URL.'/deptposts/'.md5($deptpost_id).'.'.$ext;?>"  style="width: 110px;height: auto" title="<?php echo $title;?>:aictanzania.org" alt="<?php echo $title;?>:aictanzania.org"  /></a>
								<!-- <img  src="demo/xtra/2.jpg" alt=""/> -->
								<h4 style="font-size: 10px;"> <a href="
                                
                                <?php $tit= str_replace('/','-',$title); echo BASE_URL.'/post/'.$deptpost_id.'/'.str_replace(' ','-',$tit);?>.html">
                                                <?php echo $title;?></a>
								</h4>
								<div class="clear"></div>
