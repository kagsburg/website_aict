...
<head>
		...
		<title>Add Constitution Forum Topic- Aic Admin</title>
				...
				<div class="container">
					  <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Add Forum Topic</h4>
                            </div>
                        </div>
  ...
  <?php
    if(isset($_POST['topic'])){
      ...
      if((empty($topic))||(empty($type))){
          ...
          mysqli_query($con,"INSERT INTO topics(topic,type,timestamp,status) VALUES('$topic','$type',UNIX_TIMESTAMP(),'1')") or die(mysqli_error($con));    
