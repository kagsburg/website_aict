...
<head>
		...
		<title>Department Leaders</title>
				...
				<div class="container">
					  <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Department Leaders</h4>
                            </div>
                        </div>

      <a href="adddeptleader" class="btn btn-success  btn-lg" style="margin:5px 0px"><i class="fa fa-plus"></i> Add Leader</a>
                        <div class="row">
                            <div class="col-sm-12">
...
<td>            
    ...
    <a href="activateleader.php?id=<?php echo $id;?>&&status=<?php echo $activate;?>&&pos=<?php echo $position;?>"><button class="btn btn-xs  btn-danger" onclick="return approve<?php echo $id; ?>()">Remove <i class="icon-white icon-thumbs-down"></i></button></a>
       
                               <?php   } ?>
                         <a  href="editdeptleader?id=<?php echo $id;?>" class="btn btn-xs btn-warning">Edit</a>
