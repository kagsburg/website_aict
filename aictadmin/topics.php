				...
				<div class="container">
					  <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Forum Topics</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30">All Topics</h4>
    ...
    <th >Comments</th>
     ...
     <td><?php echo mysqli_num_rows($getcomments);?></td>
              ...
              <td>
               ...
               <a  href="comments?id=<?php echo $topic_id;?>"><button  class="btn btn-xs btn-inverse">Comments</button></a> 
