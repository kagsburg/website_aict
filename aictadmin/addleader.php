...
echo '<div class="span9"><div class="alert alert-error">'.$error2.'Click <a href="adddeptleader">Here</a> to go back</div></div>';
    ...
    $ext='no';
       mysqli_query($con,"INSERT INTO deptleaders(fullnames,dob,position,dept_id,church_id,start_date,wife,poster_id,bio,ext,username,password,level,cvs,status)  VALUES('$name2','$dob2','$position','$department','$church_id','$year2','$wife2','".$_SESSION['05069']."','$bio2','$image_ext2','$username','".  md5($password)."','0','$cv_ext2','$status2')") or die(mysqli_error($con));
