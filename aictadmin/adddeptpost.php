...
echo '<div class="alert alert-danger">'.$error.'</div><br/>';
  ...
  mysqli_query($con,"INSERT INTO deptposts(post_title,description,ext,dept_id,timestamp,status)  VALUES('$article','$description','$image_ext','$department',UNIX_TIMESTAMP(),'$status')") or die(mysqli_error($con));
