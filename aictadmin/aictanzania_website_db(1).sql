...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2023 at 05:55 PM
...
--
ALTER TABLE `deptleaders`
  MODIFY `deptleader_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `news`
  MODIFY `article_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `news_photos`
--
ALTER TABLE `news_photos`
  MODIFY `photo_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
