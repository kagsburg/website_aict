...
<head>
		...
		<title>All Article Categories- Aic Admin</title>
					  ...
					  <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30">Add Article Category</h4>
                                         <?php
...
$check=  mysqli_query($con,"SELECT * FROM category WHERE category_id='$dept'");
...
echo '<div class="alert alert-error">'.$error.'</div>';
  ...
  mysqli_query($con,"INSERT INTO category(category,status)  VALUES('$dept','1')") or die(mysqli_error($con));
...
<div class="control-group">
       ...
       <tbody class="">
              <?php
               ...
               $getdept=  mysqli_query($con,"SELECT * FROM category WHERE status=1");
               while ($row2=  mysqli_fetch_array($getdept)){
               $dept=$row2['category'];
               $dept_id=$row2['category_id'];
                            ?> 
           <tr class="gradeA">
                                                                                            ...
                                                                                            <div class="modal-header">
                                                                                                                    ...
                                                                                                                    <div class="modal-body">
                                                                                                                        ...
                                                                                                                        if(isset($_POST['department'.$dept_id])){
                                                                                                                            ...
                                                                                                                            mysqli_query($con,"UPDATE category SET category='$dept' WHERE category_id='$dept_id'");
                                                                                                                            
                                                                                                                        }
                                                                                                                        ?>
                                                                                                                                                <form action=""  method="post" name="form" enctype="multipart/form-data" >
                                                                                                                                                    <div class="form-group" style="width:100%;padding:5px 0px;">
                                                                                                                                                        <label class="control-label" for="name1">Article Name</label>
                                                                                                                                                        <div class="controls">
