...
<head>
		...
		<title>Sort Department Leaders- Aic Admin</title>
...
<?php include 'includes/header.php';?>
			<div class="content-page">
				...
				<div class="container">
					  <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title"><?php echo $dept; ?></h4>
                            </div>
                        </div>
               ...
               <h4>Sort <?php echo $dept; ?> Leaders</h4>  
                         <table  class="table table-responsive table-bordered">
                                
                                <ul id="sortable">
                                <?php
       $leaders=  mysqli_query($con,"SELECT * FROM deptleaders WHERE dept_id='$id' ORDER BY level");
              ...
              $dob=$row['dob'];
               $deptleader_id=$row['deptleader_id'];           
                ...
                $level=$row['level'];
                     ...
                     echo '<li class="ui-state-default" id="item_'. $deptleader_id.'"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>#'.$level.' '.$fullname.' ('.$position.')</li>';
            }       
