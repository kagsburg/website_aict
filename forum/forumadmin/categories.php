...
<?php include 'includes/header.php'; ?>
 ...
 Add  Forum Category
    ...
    if(isset($_POST['category'])){
      $topic=  mysqli_real_escape_string($con,trim($_POST['category']));
      $category=$_POST['category'];
      if(empty($category)){
          echo '<div class="alert alert-danger">Field Required</div>';
      }  else {
          mysqli_query($con,"INSERT INTO forumcategories(forumcategory,status) VALUES('$category','1')") or die(mysqli_error($con));    
    ...
    <?php
                     ...
                     while ($row = mysqli_fetch_array($getcats)) {
                         ...
                         $forumcategory=$row['forumcategory'];
                            ...
                            ?>
     <tr class="gradeA">
               <td style="max-width: 400px"><?php echo $forumcategory_id;?></td>
     <td><?php echo $forumcategory;?></td>
                 <td>
               <a  href="editcategory?id=<?php echo $forumcategory_id;?>"><button  class="btn btn-xs btn-info">Edit</button></a> 
                   
        <a href="unpublish_category.php?id=<?php echo $forumcategory_id;?>" class="ask" onclick="return approve<?php echo $forumcategory_id; ?>()"><button class="btn btn-xs btn-danger">Remove <i class="fa fa-thumbs-down"></i></button></a>
                        
    </td>
           <script type="text/javascript">
function approve<?php echo $forumcategory_id; ?>() {
